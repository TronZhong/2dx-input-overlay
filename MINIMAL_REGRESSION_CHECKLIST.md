...
2. `powershell -NoProfile -ExecutionPolicy Bypass -File scripts/fetch-deps.ps1`
3. `cmd /c run_build.cmd`

期望结果：
- 第 2 步输出 3 个依赖均为 `PASS`。
- 第 3 步构建成功，末尾出现 `[OK] OBS plugin build completed via preset windows-x64.`
